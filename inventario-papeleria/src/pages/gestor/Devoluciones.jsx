  ...
  return (
    <div className="p-6">
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-6 gap-3">
        <h1 className="text-3xl font-semibold text-slate-800 flex items-center gap-2 whitespace-nowrap">
            ...
            {loading ? (
              ...
              filteredDevoluciones.map((devolucion, index) => (
                <tr
                  ...
                  onClick={() => navigate(`/gestor/devolucion/${devolucion.idDevolucion}`)}
                  className="border-b hover:bg-gray-50 transition cursor-pointer"
                >
                  <td className="py-3 px-4 text-gray-700 text-sm">{index + 1}</td>
                  <td className="py-3 px-4 text-gray-700 text-sm">{devolucion.observacion}</td>
      ...
      <div className="md:hidden flex flex-col gap-4">
        {loading ? (
          ...
          filteredDevoluciones.map((devolucion) => (
            ...
            >
              <div className="flex justify-between items-center mb-2">
                <span className="font-semibold text-gray-800">{devolucion.idDevolucion}</span>
          ...
          <p className="text-center text-gray-500">No hay devoluciones registradas.</p>
        )}
      </div>
    </div>
  );
